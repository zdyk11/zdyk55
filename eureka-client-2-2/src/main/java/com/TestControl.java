...
public class TestControl {
	 ...
	 * @return
	 */
	@ApiOperation(value="getService方法(value)", notes = "getService方法(notes)")
	@ApiImplicitParam(name="type", value="String(type名字随便取的)", required = true, dataType = "String")
	@RequestMapping("/getService2/{type}")
	public String getService2(@PathVariable String type) {
		return type + "client2";
	}
